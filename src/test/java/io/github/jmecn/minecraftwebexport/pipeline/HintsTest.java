...
class HintsTest {
    ...
    void mergeLanguagesPreservesFirstModuleOrder() {
        Hints first = new Hints(Map.of(), Map.of(), List.of(), false, List.of("zh_cn", "en_us"));
        Hints second = new Hints(Map.of(), Map.of(), List.of(), false, List.of("de_de", "zh_cn"));
