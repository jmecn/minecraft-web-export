...
class LangClosureKeysTest {
    ...
    void addForItemIncludesTfgBucketGtceuTemplateKeys() {
        Set<String> keys = new TreeSet<>();
        LangClosureKeys.addForItem(keys, "tfg:acetylene_bucket");
    ...
    void addForItemIncludesFluidPipeComposedKeys() {
        Set<String> keys = new TreeSet<>();
        LangClosureKeys.addForItem(keys, "gtceu:aluminium_huge_fluid_pipe");
    ...
    void addForItemIncludesGtToolComposedKeys() {
        Set<String> keys = new TreeSet<>();
        LangClosureKeys.addForItem(keys, "gtceu:bismuth_bronze_axe");
    ...
    void addForItemIncludesTfgToolComposedKeys() {
        Set<String> keys = new TreeSet<>();
        LangClosureKeys.addForItem(keys, "tfg:arsenic_bronze_pickaxe");
    ...
    void addForItemIncludesBudIndicatorKeys() {
        Set<String> keys = new TreeSet<>();
        LangClosureKeys.addForItem(keys, "gtceu:amethyst_bud_indicator");
